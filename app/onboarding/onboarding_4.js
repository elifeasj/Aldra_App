...
export default function Onboarding4() {
    ...
    const handleNext = () => {
        if (currentStep < 4) { // Antal onboarding-sider
            setCurrentStep(currentStep + 1);
        } else {
            router.push('/onboarding/onboarding_5'); // Gå videre til næste onboarding
        }
    };
    ...
    const handlePrev = () => {
        if (currentStep > 4) {
            ...
            router.push('/onboarding/onboarding_3'); // Gå tilbage
        }
    };
    ...
    return (
        <View style={styles.container}>
            {/* Billede */}
            <Image
                source={require('../../assets/images/intro_4.png')} // Skift til dit billede
                style={styles.image}
            />

            <View style={styles.topContainer}>
                <Text style={styles.title}>Skab og del minder</Text>
                <Text style={styles.subtitle}>Brug Minder-funktionen til at uploade billeder, musik og videoer.</Text>
                <Text style={styles.description}>
                    Aldra-enheden synkroniserer minderne, så de kan vises eller afspilles direkte i din kæres hjem.
                </Text>
            </View>
